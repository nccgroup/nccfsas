...
namespace Sigwhatever
{
    class TCPHTTP
    {
        public static void HTTPListener(string httpIP, string httpPort, string ipVersion, string ntlmChallenge, string computerName, string dnsDomain,
            ...
            string[] proxyIgnore, bool proxyListener, string Logfile)
        {
            ...
            while (!Program.exitInveigh)
            {
                ...
                object[] httpParams = { httpIP, httpPort, httpType, ntlmChallenge, computerName, dnsDomain, netbiosDomain, httpBasicRealm, httpAuth, httpResponse, wpadAuth, wpadResponse, wpadAuthIgnore, proxyIgnore, proxyListener, httpClient, Logfile };
        ...
        public static void GetHTTPClient(object Params)
        {
            ...
            string Logfile = Convert.ToString(httpParams[16]);
            string httpRawURL = "";
